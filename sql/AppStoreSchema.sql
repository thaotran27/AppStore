...
CREATE TABLE IF NOT EXISTS User1(
 ...
 PRIMARY KEY (Customerid, GPU_model, GPU_brand),
 ...
 GPU_model VARCHAR(32) NOT NULL,
 GPU_brand VARCHAR(32) NOT NULL,
 FOREIGN KEY (Owner_id, GPU_model, GPU_brand) REFERENCES GPU_Listing(Customerid, GPU_model, GPU_brand) ON UPDATE CASCADE ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED,
